...
const GUARANTEES = [
  {
    title: "Livraison 72h garantie",
    desc: "Si votre site n'est pas livré dans les 72h suivant la réception de vos contenus, vous êtes remboursé intégralement.",
    icon: (
  ...
  },
  {
    ...
    desc: "Une révision complète est incluse après la livraison. Textes, couleurs, disposition — on ajuste jusqu'à ce que ce soit parfait.",
    icon: (
