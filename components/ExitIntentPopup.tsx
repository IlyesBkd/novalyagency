...
export function ExitIntentPopup() {
  ...
  const modalContent = (
    <>
      ...
      {/* Modal */}
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] w-[90vw] max-w-md">
        <div className="relative rounded-2xl bg-dark-900 border border-accent-lime/20 p-8 shadow-2xl">
          {/* Close button */}
          <button
            onClick={handleClose}
          ...
          {status === "sent" ? (
            ...
            <>
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-text-primary mb-2">Attendez !</h3>
