            ...
            <div className="relative rounded-3xl p-8 sm:p-10 lg:p-12">
              {status === "sent" ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-text-secondary text-lg">Nous vous recontactons sous 24h pour lancer votre boutique.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent-lime/20 to-accent-lime/5 border border-accent-lime/20 flex items-center justify-center">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-accent-lime"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
                    </div>
                    <div>
                      <h3 className="text-text-primary font-semibold text-base">Lancez votre boutique</h3>
