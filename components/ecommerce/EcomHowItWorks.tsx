...
const STEPS = [
  {
    ...
    desc: "Décrivez votre projet e-commerce : vos produits, votre cible, vos envies. On cadre tout ensemble en 15 min.",
    icon: (
  ...
  {
    num: "02",
    title: "Vous envoyez vos produits",
    desc: "Photos, descriptions, prix, catégories. Un formulaire simple vous guide pour tout nous transmettre facilement.",
    icon: (
