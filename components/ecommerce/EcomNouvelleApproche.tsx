      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12 scroll-animate">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">
            Votre boutique <span className="gradient-text">100 % sur mesure.</span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              ...
              <ul className="space-y-3">
                {["Templates génériques Shopify", "Frais mensuels qui s'accumulent", "Design identique aux concurrents", "Configuration complexe et longue"].map((item) => (
