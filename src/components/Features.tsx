    ...
    <section id="offre" className="relative overflow-hidden bg-dark-950">
      ...
      <div className="py-20 sm:py-28 relative z-10">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div
            ref={cRef}
            className={`max-w-4xl mx-auto scroll-animate-scale ${cV ? "visible" : ""}`}
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="mb-2">
          <div className="flex items-baseline justify-center lg:justify-start gap-2">
            <span className="text-6xl sm:text-7xl lg:text-8xl font-bold text-text-primary leading-none tracking-tight">
              497
            </span>
            <span className="text-2xl sm:text-3xl font-bold text-accent-lime">
              EUR
            </span>
          </div>
        </div>
        ...
        <div className="w-full flex justify-center lg:justify-start">
          <a
            href="#commander"
            className="btn-primary group inline-flex items-center gap-3 px-8 py-4 text-base sm:text-lg"
          >
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {feats.map((f) => {
          ...
          return (
            <div
              key={f.text}
              className="group flex items-center gap-3 p-2.5 rounded-xl transition-all duration-300 hover:bg-white/[0.03]"
            >
              ...
              <span className="text-text-primary text-sm font-medium transition-colors duration-300 group-hover:text-accent-lime">
                {f.text}
              </span>
            </div>
          );
