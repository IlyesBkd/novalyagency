...
const steps = [
  { icon: Phone, number: "1", title: "Appel de cadrage", description: "15 min pour comprendre votre activité, vos besoins et définir ensemble le contenu de votre site." },
  { icon: FileText, number: "2", title: "Création sur mesure", description: "Notre équipe conçoit votre site professionnel avec un design premium adapté à votre image." },
  { icon: Rocket, number: "3", title: "Livraison en 48h", description: "Votre site est en ligne, optimisé et prêt à recevoir vos premiers visiteurs." },
];
